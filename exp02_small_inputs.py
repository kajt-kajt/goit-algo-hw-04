"""
Experiment 2 - small input sizes
"""
...
input_sizes = list(range(10,250,5))
...
with open("./textfiles/small_input_size.md","w",encoding="utf-8") as f:
...
ax.legend()
ax.grid(True)
plt.savefig("./pictures/small_input_size.png")
